...
CREATE TABLE `sertifika` (
  ...
  `veri_hash` varchar(66) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'keccak256 sertifika ozeti',
  `tx_hash` varchar(66) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'zincir islem hashi',
  `zincir_durum` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'zincir_disi' COMMENT 'zincir_disi|gonderildi|onaylandi|hata',
  PRIMARY KEY (`id`),
